...
txt.add(ru, 'tq_e1_s2_w_text', 'Теперь, когда ничто не преграждает путь, {} спокойно заходит в центральный зал ратуши. Кажется, в самом углу виднеется небольшой сундук. Давайте его откроем!')
txt.add(ru, 'b_crush_chest', '🔨 Разломать сундук')
txt.add(ru, 'b_pick_chest', '🔐 Взломать сундук')
txt.add(ru, 'b_search_chest', '🔎 Изучить сундук подробнее')
txt.add(ru, 'start_battle','⚔️ Битва')
txt.add(ru, 'creature_robber', 'Грабитель')
txt.add(ru, 'tq_e1_s2_chest_crushed', 'Сундук с треском разлетается на куски, а герой находит в его обломках оружие!')
txt.add(ru, 'tq_e1_s2_chest_picked', 'Три минуты — и замок открыт! Герой находит в сундуке оружие.')
txt.add(ru, 'tq_e1_s2_chest_searched', 'Сундук заперт на обычный металлический замок. Немного пораскинув мозгами, {} додумался поискать ключ в ящике соседнего стола.\n\nЩелк! И под крышкой герой обнаруживает оружие.')
txt.add(ru, 'tq_e1_s2_fail', 'Ничего не получается! Герою не хватает характеристик.')
